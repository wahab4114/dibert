...
class Bert_rte(nn.Module):
    def __init__(self, pretrained_model, hidden_out = rteConfig.hidden_model_out, seq_len = rteConfig.seq_len, drop_out = rteConfig.drop_out):
        super().__init__()
