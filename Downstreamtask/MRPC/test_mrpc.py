...
def main():
    ...
    model_path = 'results/full_text/dibert_MRPC_mlm_cls_pprediction_103_10_seed_2_epoch_9.tar'
    tsv_file = "results/full_text/dibert_MRPC_mlm_cls_pprediction_103_10_seed_2_epoch_9.tsv"
