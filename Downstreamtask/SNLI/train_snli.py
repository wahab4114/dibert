...
def train_val(train_data, valid_data, model_path:str,trial=None, best_params=None):
    ...
    for epoch in range(epochs):
        ...
        if(trial is None and best_params is not None):
            print('-saving model-')
            torch.save(model, 'results/full_text/dibert_SNLI_mlm_cls_pprediction_103_10_seed_'+str(4)+'_epoch_'+str(epoch+1)+'.tar')
...
if __name__ == '__main__':
    param_path = 'results/full_text/params/dibert_SNLI_mlm_cls_pprediction_10_best.json'
