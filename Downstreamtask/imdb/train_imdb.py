...
from Downstreamtask.imdb.imdbmodel import Bert_imdb
import tqdm
import random
import optuna
...
if __name__ == '__main__':
    ...
    train_data = IMDBdataset(train_data_split)
    valid_data = IMDBdataset(valid_data_split)
    test_data = IMDBdataset(test_data_split)


    train_data_loader = DataLoader(train_data, batch_size=imdbConfig.batch_size)
    valid_data_loader = DataLoader(valid_data, batch_size=imdbConfig.batch_size)
