...
class Bert_imdb(nn.Module): #for checking sota results
    def __init__(self, pretrained_model, hidden_out = imdbConfig.hidden_model_out, seq_len = imdbConfig.seq_len, drop_out = imdbConfig.drop_out):
        super().__init__()
