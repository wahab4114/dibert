...
class Bert_qnli(nn.Module):
    def __init__(self, pretrained_model, hidden_out = qnliConfig.hidden_model_out, seq_len = qnliConfig.seq_len, drop_out = qnliConfig.drop_out):
        super().__init__()
