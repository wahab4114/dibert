...
from Downstreamtask.QQP.qqpmodel import Bert_qqp
import tqdm
import random
import optuna
...
if __name__ == '__main__':
    ...
    train_data = QQPdataset('train')
    valid_data = QQPdataset('validation')
    ...
    train_data_loader = DataLoader(train_data, batch_size=qqpConfig.batch_size)
    valid_data_loader = DataLoader(valid_data, batch_size=qqpConfig.batch_size)
    ...
    if(is_tune == False):
        ...
        print_result(score, qqpConfig.epochs)
    elif(is_tune == True):
        print(param_path)
