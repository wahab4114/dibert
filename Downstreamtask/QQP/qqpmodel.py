...
class Bert_qqp(nn.Module):
    def __init__(self, pretrained_model, hidden_out = qqpConfig.hidden_model_out, seq_len = qqpConfig.seq_len, drop_out = qqpConfig.drop_out):
        super().__init__()
